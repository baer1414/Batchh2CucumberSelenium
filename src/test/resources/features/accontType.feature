Feature: Account Type
  ...
  Scenario: first user
    ...
    When  When User should input "coday3434@gmail.com" and "34352023"
    Then The user name should be "Harun"
@wip
  Scenario: Second user
    Given User should be on the login page
    When When User should input "eddiem@kraft.com" and "eddiem12"
    Then The user name should be "Eddie Murphy"

  Scenario: Third user
    Given User should be on the login page
    When When User should input "morganfreeman@kraft.com" and "mfreeman"
    Then The user name should be "Morgan Freeman"

  Scenario: fourth user
    Given User should be on the login page
    When When User should input "krafttech@kraft.com" and "Test1234"
    Then The user name should be "Kyle Masters"

  Scenario Outline:Different <name> user type
    Given User should be on the login page
    When  When User should input "<userEmail>" and "<password>"
